...
namespace BuddyMatch.Api.Migrations
{
    ...
    [Migration("20250923213223_AddBuddyProfileFields")]
    partial class AddBuddyProfileFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BuddyMatch.Api.Models.BuddyProfile", b =>
                {
                    ...
                    b.Property<string>("BuddyLocation")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("BuddyTechStack")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("BuddyUnit")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
